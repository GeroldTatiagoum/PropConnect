...
let AuthController = class AuthController {
    ...
    async register(dto) {
        const { user, accessToken, refreshToken, expiresIn } = await this.authService.register(dto);
        return {
            id: user.id,
            email: user.email,
    ...
    async login(dto, req) {
        ...
        const { user, accessToken, refreshToken, expiresIn } = await this.authService.login(dto, ip);
        return {
            id: user.id,
            email: user.email,
            role: user.role,
